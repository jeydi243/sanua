import type { SupabaseClient } from '@supabase/supabase-js' // Importez le type SupabaseClient
...
export const useSupabase = (): SupabaseClient => {
    ...
    if (!nuxtApp.$supabase) {
        throw new Error(
            'Supabase client non disponible. Assurez-vous que le plugin Supabase est correctement configuré.',
        )
    }
