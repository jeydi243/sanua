    ...
    <Sheet v-model:open="isOpen">
        <SheetContent class="w-[70vw] sm:max-w-none">
            <SheetHeader>
                ...
                <SheetDescription> Remplissez les informations ci-dessous pour créer un nouveau prêt pour ce client. </SheetDescription>
            </SheetHeader>
            <div class="py-4 p-8">
                <form class="space-y-4" @submit="onSubmit">
                    ...
                    <SheetFooter class="flex flex-row justify-end">
                        <Button type="reset" :disabled="isSubmitting" class="w-1/2" variant="outline">
                            <Icon v-if="isSubmitting" name="line-md:refresh" class="mr-2" />
                            Reset
                        </Button>
