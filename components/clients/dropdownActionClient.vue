...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem @click="goToClientDetails"> Voir les détails </DropdownMenuItem>
            <DropdownMenuItem @click="editClient"> Modifier </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem class="text-red-600" @click="deleteClient"> Supprimer </DropdownMenuItem>
        </DropdownMenuContent>
    </DropdownMenu>
</template>
