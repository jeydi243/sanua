        ...
        <div class="rounded-md border">
            <Table>
                ...
                <TableBody>
                    ...
                    <TableRow v-else>
                        <TableCell :colspan="columns.length" class="h-24 text-center"> Aucun lookup ! </TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        </div>
...
import { getCoreRowModel, getExpandedRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, useVueTable } from '@tanstack/vue-table'
