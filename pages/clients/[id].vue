    ...
    <div class="flex flex-1 flex-col gap-4 p-4 md:gap-8">
        ...
        <Tabs default-value="comptes" class="w-full">
            <TabsList>
                ...
                <TabsTrigger value="garants">Garants</TabsTrigger>
                <TabsTrigger value="transactions">Transactions</TabsTrigger>
            </TabsList>

            <!-- Onglet Comptes -->
            <TabsContent v-motion-fade value="comptes">
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between">
                        ...
                        <CreateCompteSheet v-if="clientId" v-model:open="isCompteSheetOpen" :client-id="clientId" />
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
            ...
            <!-- Onglet Prêts -->
            <TabsContent v-motion-fade value="prets">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
                        <Button variant="ghost" class="float-left w-24" @click="isPretSheetOpen = true">
            ...
            <!-- Onglet activite -->
            <TabsContent v-motion-fade value="activite">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
            ...
            <!-- Onglet details -->
            <TabsContent v-motion-fade value="details">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
            ...
            <!-- Onglet adresses -->
            <TabsContent v-motion-fade value="adresses">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
            ...
            <!-- Onglet garants -->
            <TabsContent v-motion-fade value="garants">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
            ...
            <!-- Onglet transactions -->
            <TabsContent v-motion-fade value="transactions">
                <Card>
                    <CardHeader>
                        <CardTitle>Prêts du Client</CardTitle>
                        <CardDescription>Liste des prêts accordés au client.</CardDescription>
...
const isCompteSheetOpen = ref(false)
